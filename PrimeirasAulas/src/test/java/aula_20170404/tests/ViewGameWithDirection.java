package aula_20170404.tests;

import java.io.*;

import eightPuzzleGame.domain.ShufflePuzzleLevelHard;
import eightPuzzleGame.domain.ShufflePuzzleLevelEasy;
import eightPuzzleGame.domain.ShufflePuzzleLevelMedium;
import eightPuzzleGame.domain.Puzzle;
