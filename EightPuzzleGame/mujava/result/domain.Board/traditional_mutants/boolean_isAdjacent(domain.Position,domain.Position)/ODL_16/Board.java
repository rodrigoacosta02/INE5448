...
public class Board
{
    ...
    {
        return this.isInsideTheBoard( position1 ) && this.isInsideTheBoard( position2 ) && (Math.abs( position1.getColumn() - position2.getColumn() ) == 1 || position1.getColumn() == position2.getColumn() && Math.abs( position1.getLine() - position2.getLine() ) == 1);
    }
