...
public class Board
{
    ...
    {
        return this.isInsideTheBoard( position1 ) && this.isInsideTheBoard( position2 ) && (position1.getLine() == position2.getLine() && Math.abs( position1.getColumn() - position2.getColumn() ) == 1 || position1.getColumn() == position2.getLine() && Math.abs( position1.getLine() - position2.getLine() ) == 1);
    }
